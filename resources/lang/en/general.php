...
return [
    ...
    "LBL_NETWORK_COMMISSIONS" => "Network Commissions",
    "LBL_FSP" => "Financial Service Provider",
    "LBL_TRANSACTION_COUNT" => "Transaction Count",
    "LBL_COMMISSION_RATE" => "Commission Rate",
    "LBL_COMMISSION_AMOUNT" => "Commission Amount",
    "LBL_NO_COMMISSIONS_FOUND" => "No commissions found",

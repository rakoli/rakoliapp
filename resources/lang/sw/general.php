...
return [
    ...
    "LBL_AGENCY" => "Wakala",
    "LBL_SHIFT" => "Zamu",
    "LBL_CASH_AT_HAND" => "Pesa Mkononi",
    "LBL_TOTAL_CASH_AT_HAND" => "Jumla ya kiasi cha pesa uliyonacho mkononi",
    "LBL_NETWORKS" => "Mitandao",
    "LBL_NETWORK" => "Mtandao",
    "LBL_SELECT_NETWORK" => "Chagua Mtoa Huduma wa Mtandao",
    'LBL_SELECT_LOCATION' => 'Chagua Mahali',
    "LBL_LOANS" => "Mikopo",
    ...
    "LBL_TRANSACTION_HISTORY" => "Historia ya Miamala",
    ...
    "LBL_AGENT_TILL_NO" => "Namba ya Wakala",

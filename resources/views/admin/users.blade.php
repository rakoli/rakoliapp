				...
				<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
					...
					<tbody class="fw-semibold text-gray-600">
						...
						<tr>
							...
							<td>
								<a href="/dashboard/view/user-details?id={{ $user->id }}" class="text-gray-800 text-hover-primary mb-1">{{ $user->name }}</a>
							</td>
							<td>
								<a href="/dashboard/view/user-details?id={{ $user->id }}" class="text-gray-600 text-hover-primary mb-1">{{ $user->email}}</a>
							</td>
							<td>
								<a href="/dashboard/view/user-details?id={{ $user->id }}" class="text-gray-600 text-hover-primary mb-1">{{ $user->phone}}</a>
							</td>
							<td>
								<a href="/dashboard/view/user-details?id={{ $user->id }}" class="text-gray-600 text-hover-primary mb-1">{{ $user->country_code}}</a>
							</td>
							<td>{{ $user->type}}</td>
							 					 
							<td class="text-end">
								<a href="/dashboard/view/user-details?id={{ $user->id }}" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
								<i class="ki-outline ki-down fs-5 ms-1"></i></a>
								<!--begin::Menu-->
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
									<!--begin::Menu item-->
									<div class="menu-item px-3">
										<a href="/dashboard/view/user-details?id={{ $user->id }}" class="menu-link px-3">View</a>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu item-->
									<div class="menu-item px-3">
										<a href="/dashboard/view/user-disable?id={{ $user->id }}" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Disable</a>
									</div>
									<!--end::Menu item-->
								</div>
								<!--end::Menu-->

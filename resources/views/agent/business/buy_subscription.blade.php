...
<div id="kt_content_container" class="container-xxl">
    ...
    <div class="card mb-5 mb-xl-8 d-flex">
        ...
        <div class="w-800">
            ...
            <div>
                <!--begin::Title-->
                <h2 class="text-center mt-7 fw-bold text-dark">{{__('Select Package')}}</h2>
                <!--end::Title-->
                <!--begin::Notice-->
                <div class="text-center text-muted fw-semibold fs-6">{{__('Choose a subscription package that fits your business needs')}}.</div>
                <!--end::Notice-->
            </div>
            <!--end::Heading-->
            <!--begin::Plans-->

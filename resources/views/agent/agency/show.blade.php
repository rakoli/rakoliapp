                        ...
                        <div class="card bg-primary">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <!--end::Amount-->
                                    <!--begin::Subtitle-->
                                    <span class="text-white pt-1 fw-semibold fs-6">{{ __('Debit (cash in)') }} in {{currencyCode()}}</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            </div>
                        ...
                        <div class="card bg-primary">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <!--end::Amount-->
                                    <!--begin::Subtitle-->
                                    <span class="text-white pt-1 fw-semibold fs-6">{{ __('Credit (cash out)') }} in {{currencyCode()}}</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            </div>
                        ...
                        <div class="card bg-primary">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-title d-flex flex-column">
                                    <!--begin::Amount-->
                                    <span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2"  data-kt-countup="true"
                                          data-kt-countup-value="{{ number_format($capital , 2) }}"

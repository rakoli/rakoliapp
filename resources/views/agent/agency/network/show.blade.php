...
@section('title', "Show $network->name")
                                                    ...
                                                    <table id="kt_customer_details_invoices_table_1"
                                                        ...
                                                        <tr class="odd">
                                                            <td data-order="Invalid date">
                                                                @if($network->type == App\Utils\Enums\NetworkTypeEnum::FINANCE->value)
                                                                    <img src="{{ $network->agency?->getLogo() }}" class="img-flag"> {{ $network->agency?->name }}
                                                                @else 
                                                                    {{ $network->crypto?->name }}
                                                                @endif    
                                                            </td>

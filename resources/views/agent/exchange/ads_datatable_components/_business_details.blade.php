<div class="d-flex align-items-center w-250px">
    ...
    <div class="d-flex flex-column justify-content-center">
        ...
        <div class="fw-semibold text-gray-600">{{$ad->business->exchange_stats->no_of_trades_completed}} trades | {{$ad->business->exchange_stats->getCompletionRatePercentage()}}% completion</div>

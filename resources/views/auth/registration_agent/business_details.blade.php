<div class="" data-kt-stepper-element="content">
    ...
    <div class="w-100">
        ...
        <div class="mb-5 fv-row">
            ...
            <input type="text" name="business_name" id="business_name" class="form-control form-control-solid" placeholder="Enter Business Name"/>
        </div>
        <!--end::Input group-->
        <!--begin::Notice-->
        ...
        <div class="mb-10 fv-row">
            ...
            <input type="text" name="reg_id" id="reg_id" class="form-control form-control-solid" placeholder="Enter Registrar Identification"/>
        </div>
        <!--end::Input group-->
        <!--begin::Input group-->
        <div class="mb-10 fv-row">
            <label for="tax_id" class="form-label">TAX Identification</label>
            <input type="text" name="tax_id" id="tax_id" class="form-control form-control-solid" placeholder="Enter TAX Identification"/>
        </div>
        <!--end::Input group-->
        <!--begin::Input group-->
        <div class="mb-10 fv-row" id="regdate_picker" data-td-target-input="nearest" data-td-target-toggle="nearest">
            ...
            <div class="input-group">
                <input id="regdate_picker_input" type="text" class="form-control form-control-solid"
                       data-td-target="#regdate_picker" data-td-toggle="datetimepicker" placeholder="Select Business Registration Date"/>

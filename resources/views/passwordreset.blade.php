...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../"/>
		<title>RAKOLI - {{ $translator("Reset password", "Rudisha nenosiri") }} </title>
		<meta charset="utf-8" />
				...
				<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
					...
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
						...
						<div class="w-lg-500px p-10">
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" id="kt_password_reset_form" data-kt-redirect-url="confirm-email" action="/reset-password-action">
                                <!--begin::Heading-->
                                <div class="text-center mb-10">
                                    <!--begin::Title-->
                                    <h1 class="text-dark fw-bolder mb-3">{{ $translator("Forgot Password ?", "Umesahau Nenosiri ?") }}</h1>
                                    <!--end::Title-->
                                    <!--begin::Link-->
                                    <div class="text-gray-500 fw-semibold fs-6">{{ $translator("Enter your email to reset your password.", "Ingiza barua pepe yako kusahihisha nenosiri lako.") }}</div>
                                    <!--end::Link-->
                                </div>
                                <!--begin::Heading-->
                                <!--begin::Input group=-->
                                ...
                                <div class="d-flex flex-wrap justify-content-center pb-lg-0">
                                    <button type="button" id="kt_password_reset_submit" class="btn btn-primary me-4">
                                        ...
                                        <span class="indicator-label">{{ $translator("Submit", "Tuma") }}</span>
                                        <!--end::Indicator label-->
                                    ...
                                    <a href="/" class="btn btn-light">{{ $translator("Cancel", "Ghairi") }}</a>
                                </div>
                                <!--end::Actions-->
                            </form>

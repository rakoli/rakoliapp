...
if (! function_exists('getLocaleSVGImagePath')) {
...
if (! function_exists('xmlToArrayConvert')) {
...
if (! function_exists('setupSession')) {
...
if (! function_exists('getApiSessionData')) {
...
if (! function_exists('returnActiveMenuStyle')) {
...
if (! function_exists('returnActiveSubMenuStyle')) {
...
if (! function_exists('str_camelcase')) {
...
if (! function_exists('tradeOrderInvence')) {
...
if (! function_exists('idNumberDisplay')) {
...
if (! function_exists('hasOpenShift')) {
...
if (! function_exists('getOpenShift')) {
...
if (! function_exists('validateSubscription')) {
...
if (! function_exists('runDatabaseTransaction')) {
